...
import TeleviziaFormReady from "./televizia-form-ready";
import RadaFormReady from "./rada-form-ready";
//@@viewOff:imports

const STATICS = {
  //@@viewOn:statics
  displayName: Config.TAG + "TeleviziaForm",
  //@@viewOff:statics
};

export const TeleviziaForm = createComponent({
  ...STATICS,
  ...
  render(props) {
    ...
    function handleClick(){
      modalRef.current.open({
        header: " ",
        content: (<TeleviziaFormReady data={data} handleClose={handleClose}/> ),
      })
    }
