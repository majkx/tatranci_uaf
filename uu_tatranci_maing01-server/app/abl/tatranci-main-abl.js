...
const Errors = require("../api/errors/tatranci-main-error.js");
...
const logger = LoggerFactory.get("TatranciMainAbl");

class TatranciMainAbl {
  constructor() {
...
module.exports = new TatranciMainAbl();
